...
void find_limit_with_loop(){
    ...
    */
    ...
    Double_t alpha = 0.00225;
    Int_t steps = 10000;
    TH1F* sig_dist = new TH1F("hsig", "Distribution of fitted signal parameter", 50, -100, 175);
    ...
    std::cout << "integral from 0: " << 1 - sig_dist->Integral(1,sig_dist->FindBin(1))/sig_dist->Integral() << "\n";

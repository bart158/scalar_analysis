...
string treename = "tree";         // tree name (should be the same in all input files)
        ...
        void train_bdt_qqll_v1(string mass_point = "20", int beamsetting = 4, string variables = "Nel Nmu Nisr Nph jet1btag jet2btag Mjj Mcorr Mrec Etot log10(y23) log10(y34) log10(y45) costhetajetcms jetpt  Z.M() Z.Pt() Z.E()", // input BDT variable names
 ...
 // ---------------------------------------------------------------
   ...
   */
   ...
   // Define signal and background trees
    ...
    TFile* sigfile = new TFile(path + "bbll_sig_" + mass_point + "_eRpL_new.root");
    TFile* sigfile2 = new TFile(path + "bbll_sig_" + mass_point + "_eLpR_new.root");

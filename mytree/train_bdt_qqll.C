 ...
 // ---------------------------------------------------------------
   ...
   */
   ...
   // Define signal and background trees
    ...
    TFile* sigfile = new TFile("bbll_sig_80_eRpL_new.root");
   ...
   TFile* bgfile = new TFile("qqll_bg_eRpL_new.root");
   ...
   TTree *bgevt = (TTree *)(bgfile->FindObjectAny(treename.c_str()));

   
   dataloader->AddBackgroundTree( bgevt, backgroundWeight,  TMVA::Types::kMaxTreeType  );
